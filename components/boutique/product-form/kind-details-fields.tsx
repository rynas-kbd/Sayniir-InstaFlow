    ...
    <FormSection icon={Calendar} label="Détails du service">
      <div className="flex flex-col gap-3.5 sm:flex-row">
        <div className="flex-1">
          <Field label="Durée (minutes)" htmlFor="p-duration" error={errors.duration_minutes}>
            <Input
        ...
        <div className="flex-1">
          <Field label="Lieu" htmlFor="p-location">
            <Input
              id="p-location"
              value={form.location}
...
function DigitalFields({ api }: { api: ProductFormApi }) {
  ...
  return (
    <FormSection icon={Calendar} label="Fichier digital">
      <div className="flex flex-col gap-3.5 sm:flex-row">
        <div className="flex-1">
          <Field label="URL du fichier" htmlFor="p-file" error={errors.file_url}>
            <Input
        ...
        <div className="flex-1">
          <Field label="Limite de téléchargements" htmlFor="p-download-limit" error={errors.download_limit} hint="Illimité si vide">
            <Input
              {...fieldA11y('p-download-limit', { hint: 'Illimité si vide', error: errors.download_limit })}
              type="number"
...
function SubscriptionFields({ api }: { api: ProductFormApi }) {
  ...
  return (
    <FormSection icon={Calendar} label="Facturation">
      <Field label="Période de facturation" htmlFor="p-billing">
...
function EventFields({ api }: { api: ProductFormApi }) {
  ...
  return (
    <FormSection icon={Calendar} label="Événement">
      <div className="flex flex-col gap-3.5 sm:flex-row">
        <div className="flex-1">
          <Field label="Date" htmlFor="p-event-date" error={errors.event_date}>
            <Input
        ...
        <div className="flex-1">
          <Field label="Places disponibles" htmlFor="p-capacity" error={errors.capacity}>
            <Input
